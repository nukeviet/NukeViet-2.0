...
if ( $numstories > 0 )
{
	...
	while ( $rowlast10articl = $db->sql_fetchrow($resultlast10art) )
	{
		...
		if ( $imglast10art != "" and file_exists("" . $path . "/" . $imglast10art . "") )
		{
			...
			$content .= "<tr><td valign=\"center\" width=\"$sizeximg\" align=\"center\"><a title=\"$titlelast10art\" href=\"modules.php?name=News&op=viewst&sid=$sidlast10art\"><img border=\"0\" src=\"$path/$imglast10art\" width=\"$sizeximg\"></a></td></tr>\n";
		}
		$content .= "<tr><td width=\"100%\" align=\"left\"><a href=\"modules.php?name=News&op=viewst&sid=$sidlast10art\">$titlelast10art</a></td></tr></table></td>\n</tr>\n";
		$a = $a + 1;
	}
