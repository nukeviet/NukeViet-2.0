...
for ( $i = 0; $i < 10; $i++ )
{
	$sql = "SELECT * FROM " . $prefix . "_nvvotings $querylang ORDER BY rand() DESC";
...
if ( $row )
{
	...
	{
		$errsm = "'" . _ALERTPOLL8 . "'";
		$content1 = "<form name=\"frmpoll\" action=\"" . INCLUDE_PATH . "modules.php?name=Voting\" method=\"post\" onsubmit=\"return chkSelect($errsm)\">";
