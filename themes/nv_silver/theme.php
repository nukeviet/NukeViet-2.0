...
function OpenTable() {
    echo "<table border=\"1\" width=\"100%\" cellspacing=\"0\" cellpadding=\"5\" bgcolor=\"#fafafa\" style=\"border-collapse: collapse\" bordercolor=\"#BBBBBB\"><tr><td>";
}
...
function themesidebox($title, $content, $link) {
  ...
  if ($block_side == "l") {
echo "    <TABLE style=\"MARGIN-BOTTOM: 2px; PADDING-BOTTOM: 2px; WIDTH: 100%; BACKGROUND-COLOR: #FAFAFA\" cellSpacing=0 cellPadding=0>\n"; 
...
echo "  <TABLE style=\"MARGIN-BOTTOM: 2px; PADDING-BOTTOM: 2px; WIDTH: 100%; BACKGROUND-COLOR: #FAFAFA\" cellSpacing=0 cellPadding=0>\n"; 
echo "  <TBODY><TR><TD style=\"BORDER-RIGHT: #c6c6c6 1px solid; BORDER-TOP: #c6c6c6 0px solid; BORDER-LEFT: #c6c6c6 1px solid; BORDER-BOTTOM: #c6c6c6 1px solid; BACKGROUND-IMAGE: url(".INCLUDE_PATH."themes/".$ThemeSel."/images/".$currentlang."/menu_bg.gif); HEIGHT: 23px\">\n"; 
echo "  <IMG style=\"VERTICAL-ALIGN: middle\" height=16 alt=\"\" src=\"".INCLUDE_PATH."themes/".$ThemeSel."/images/".$currentlang."/large_icons_16x16.gif\" width=16> \n"; 
if ($link != "") { 
  echo "<a class=\"A_white\" href=\"".$link."\">".$title."</a>";
  }else{
...
echo "  <TBODY><TR><TD style=\"BORDER-RIGHT: #c6c6c6 1px solid; BORDER-TOP: #c6c6c6 0px solid; BORDER-LEFT: #c6c6c6 1px solid; BORDER-BOTTOM: #c6c6c6 1px solid; BACKGROUND-IMAGE: url(".INCLUDE_PATH."themes/".$ThemeSel."/images/".$currentlang."/menu_bg.gif); HEIGHT: 23px\">\n"; 
echo "  <IMG style=\"VERTICAL-ALIGN: middle\" height=16 alt=\"\" src=\"".INCLUDE_PATH."themes/".$ThemeSel."/images/".$currentlang."/large_icons_16x16.gif\" width=16> \n"; 
echo "<font class=\"A_white\">".$title2."</font>";
echo "  </TD></TR>\n"; 
echo "  <TR><TD style=\"BORDER-RIGHT: #c6c6c6 1px solid; BORDER-TOP: #c6c6c6 0px solid; BORDER-LEFT: #c6c6c6 1px solid; BORDER-BOTTOM: #c6c6c6 1px solid\">\n"; 
echo " $content_2\n"; 
echo "  </TD></TR></TBODY></TABLE>\n";
